...
//
// Tips: Implement a constructor that supports list initialization, calculate
// container size, understand initializer_list and pass runtime checks
//
// Docs:
...
public:
  ...
  MyVector(std::initializer_list<int> initList)
      : mSize(static_cast<int>(initList.size())) {
    // You can also store the elements if needed
  }
